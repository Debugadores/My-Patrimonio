        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="<?= htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
                <!-- Email Field -->
                ...
                <!-- Password Field -->
                <div class="mb-3 form-password-toggle <?= (!empty($password_err)) ? 'has-error' : ''; ?>">
